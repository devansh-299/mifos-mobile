...
import org.mifos.mobile.presenters.LoanAccountTransactionDetailsPresenter;
...
public class LoanAccountTransactionDetailFragment extends BaseFragment implements
    ...
    @Inject
    LoanAccountTransactionDetailsPresenter loanAccountTransactionDetailsPresenter;
    ...
    public static LoanAccountTransactionDetailFragment newInstance(
            long accountId, long transactionId) {
        LoanAccountTransactionDetailFragment fragment = new LoanAccountTransactionDetailFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        loanAccountTransactionDetailsPresenter.attachView(this);
        sweetUIErrorHandler = new SweetUIErrorHandler(getContext(), rootView);

        if (savedInstanceState == null) {
            loanAccountTransactionDetailsPresenter.loadTransactionDetails(accountId,
                    transactionId);
        }
        return rootView;
    }
    ...
    public void onDestroyView() {
        super.onDestroyView();
        hideProgressBar();
        loanAccountTransactionDetailsPresenter.detachView();
    }
